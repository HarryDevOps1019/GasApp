...
const IndCustOrderHistory: React.FC<Props> = ({ navigation, route }) => {
  ...
  const fetchOrderHistory = async () => {
    try {
      ...
      const customerEmail = customerSnapshot.val().email;
      ...
      tokenSnapshot.forEach((childSnapshot) => {
        ...
        if (orderData.email === customerEmail && orderData.status === "Completed") {
          ...
          orders.map((order) => (
            <View key={order.token} style={styles.orderCard}>
              <View style={styles.orderHeader}>
                <Text style={styles.outletName}>Outlet Name: {order.outletName}</Text>
