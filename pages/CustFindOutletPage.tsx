...
type RootStackParamList = {
  ...
  OrderHistoryPage: { custPrimaryKey: string };
  IndCustHomePage: { custPrimaryKey: string };
  IndCustProfile: { custPrimaryKey: string };
  IndCustGasReqForm: { selectedOutlet: string }; // Modified this line
};

type Props = NativeStackScreenProps<RootStackParamList, "CustFindOutletPage">;
...
const CustFindOutletPage: React.FC<Props> = ({ navigation, route }) => {
...
export default CustFindOutletPage;